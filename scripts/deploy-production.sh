...
#helm install
helm install --namespace production --name dotnetcorebmb-latest-prod --set image.repository=rafaelbotelhoawtce/hdc,image.tag=latest helm/devops

#helm upgrade
helm upgrade --install --namespace production dotnetcorebmb-latest-prod --set image.repository=rafaelbotelhoawtce/hdc,image.tag=latest helm/devops
